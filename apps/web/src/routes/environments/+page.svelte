...
<script lang="ts">
  ...
  import { page } from '$app/stores'; // optional if you want route info
  ...
  // Show "Create New Environment" modal
...
<div class="bg-gray-100 min-h-screen p-8">
  <div class="max-w-7xl mx-auto">
    <div class="flex justify-between items-center mb-6">
      ...
      <!-- Button to open the Create Environment modal -->
      <button
        ...
        {#if data.environments && data.environments.length > 0}
          <div class="grid gap-4">
            {#each data.environments as env}
              <div class="block bg-white border border-gray-200 rounded-lg p-4 hover:shadow transition">
                <div class="flex items-center justify-between mb-1">
                  <h3 class="text-lg font-semibold text-gray-800">{env.name}</h3>
                  <!-- "Manage" link goes to environment details page, if needed -->
                  <a
...
{#if showCreateModal}
  <div
    ...
    on:click={(e) => {
      ...
      if (e.target.classList.contains('bg-black')) closeModals();
    }}
  >
    <div
    ...
    >
      ...
      <!-- SvelteKit Action form pointing to ?/createEnv -->
...
{#if showEditModal && editEnvId !== null}
  ...
  >
    ...
    >
      ...
      <!-- SvelteKit Action form pointing to ?/updateEnv -->
...
{#if showDeleteModal && deleteEnvId !== null}
  ...
  >
    ...
    >
      ...
      <!-- SvelteKit Action form pointing to ?/deleteEnv -->
